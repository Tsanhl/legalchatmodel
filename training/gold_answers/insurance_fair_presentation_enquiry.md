Because this is business insurance, the principal regime is the statutory duty of fair presentation, not an automatic all-or-nothing avoidance rule (Insurance Act 2015, s 3). The insurer must prove that the earlier loss was material and that the actual underwriter was induced by the non-disclosure; the remedy then depends on what the policyholder knew and what the insurer would have done with a fair presentation.

### Duty, materiality and inducement
...
If the breach was deliberate or reckless, the insurer may avoid the contract, refuse all claims and retain the premium (Insurance Act 2015, sch 1). For any other qualifying breach, the remedy is proportionate to the underwriting counterfactual. If the insurer would not have contracted, it may avoid but must return premium; if it would have imposed different terms, the contract is treated as containing them; if it would have charged a higher premium, claim payment is reduced proportionately (Insurance Act 2015, sch 1).

The business should request the underwriting file, guidelines, proposal, broker record and the insurer’s pleaded counterfactual. It should notify the claim and challenge avoidance promptly through the policy complaint route, the Financial Ombudsman Service if eligible, or court proceedings. The likely outcome cannot be determined from the label “minor”: it turns on materiality, actual inducement, culpability and credible evidence of the terms the insurer would have offered.
